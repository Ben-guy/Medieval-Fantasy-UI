...
public class ScrollRectAutoScroll : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void OnEnable()
    {
        Action = controller.UIControls.Vertical;
        Action.Enable();

        controller.UIControls.Vertical.performed += verticalInput;
        controller.UIControls.Vertical.Enable();
    ...
    private void verticalInput(InputAction.CallbackContext obj)
    {
